            ...
            <!-- <div class="mt-4 bg-white overflow-hidden shadow-sm sm:rounded-lg"> -->
                <!-- <div class="p-6 bg-white border-b border-gray-200"> -->
                    <div class="my-4">
                        ...
                        <a href="{{ route('skp.index') }}" class="m-4">Back</a>
                            ...
                            <form action="{{ route('skp.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-6">
                                    ...
                                    <input type="text" class="form-control
                                        ...
                                        ease-in-out
                                        m-0
                                        focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" placeholder="Masukkan Nama" name="nama">
                                </div>
